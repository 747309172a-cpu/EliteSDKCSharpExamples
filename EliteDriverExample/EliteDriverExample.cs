...
internal static class DriverExample
{
    ...
    private const string DefaultScriptFilePath = "resource/external_control.script";
    private const string DefaultLocalIp = "";
    private const bool DefaultHeadless = true;
    private const string DefaultSshPassword = "";
    private const bool DefaultWithRs485 = false;
    ...
    internal static void Run(string[] args)
    {
        ...
        var scriptFilePath = DefaultScriptFilePath;
        var localIp = DefaultLocalIp;
        var headless = DefaultHeadless;
        var sshPassword = DefaultSshPassword;
        var withRs485 = DefaultWithRs485;
